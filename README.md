...
![Real homelab investigation: inactive media storage is identified as the likely Jellyfin failure](docs/assets/demo.gif)

The demo is generated by running the real CLI against the checked-in
[incident fixture](docs/assets/demo-incident.inventory.yaml); its reproducible
[VHS source](docs/assets/demo.tape) is included in the repository.
